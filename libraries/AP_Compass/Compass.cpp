...
const AP_Param::GroupInfo Compass::var_info[] = {
    ...
    // @User: Advanced
    AP_GROUPINFO("MOTCT",    6, Compass, _motor_comp_type, Compass::motor_compensation_disabled),
...
//    NOTE: This orientation is combined with any AHRS_ORIENTATION setting.
    ...
    // 8:Roll180,9:Roll180Yaw45,10:Roll180Yaw90,
    // 11:Roll180Yaw135,12:Pitch180,13:Roll180Yaw225,
    // 14:Roll180Yaw270,15:Roll180Yaw315,16:Roll90,
    // 17:Roll90Yaw45,18:Roll90Yaw90,19:Roll90Yaw135,
    // 20:Roll270,21:Roll270Yaw45,22:Roll270Yaw90,
    // 23:Roll270Yaw136,24:Pitch90,25:Pitch270,
    // 26:Pitch180Yaw90,27:Pitch180Yaw270,
    // 28:Roll90Pitch90,29:Roll180Pitch90,
    // 30:Roll270Pitch90,31:Roll90Pitch180,
    // 32:Roll270Pitch180,33:Roll90Pitch270,
    // 34:Roll180Pitch270,35:Roll270Pitch270,
    ...
    _hil_mode(false)
{
    ...
    for (uint8_t i=0; i<Compass::m_max_backends; i++) {
        _backends[i] = NULL;
...
{
    if (_compass_count == Compass::m_max_instances) {
...
void Compass::_add_backend(AP_Compass_Backend *backend)
{
    if (!backend)
        return;
    if (_backend_count == Compass::m_max_backends)
...
Compass::save_motor_compensation()
{
    ...
    for (uint8_t k=0; k<Compass::m_max_instances; k++) {
...
{
    if (_motor_comp_type <= motor_compensation_current && _motor_comp_type != (int8_t)comp_type) {
